...
Suppose hypothetically we had a scenario where by 1st March 2023, 18 deaths had been reported in the outbreak. We can therefore use the `known_outcomes()` function from `cfr` to estimate the number of cases that have a known outcome by this point, and compare with a 'naive' estimate that doesn't account for delays.
